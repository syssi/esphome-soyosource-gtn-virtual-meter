...
static const std::vector<uint8_t> MODBUS_FRAME = {0x23, 0x01, 0x01, 0x00, 0x00, 0x02, 0x3E,
                                                   0x00, 0x17, 0x00, 0xEF, 0x64, 0x02, 0x9E, 0xB5};

static const std::vector<uint8_t> MODBUS_FRAME_DATA = {0x00, 0x02, 0x3E, 0x00, 0x17,
                                                        0x00, 0xEF, 0x64, 0x02, 0x9E};
